...
package ds504.demorris.flink.covtype;
...
public class DataStreamJob {
        ...
        public static void main(String[] args) throws Exception {
                ...
                int numAttributes = 54;
                int numClasses = 7;
                int targetIndex = 54;
                String filePath = "file:///root/data/covtype/covtype.data";
                String cliString = "meta.LimAttClassifier -n 2";
		...
		protected void generateHeader(){
			...
			for (int i=0; i < this.numAttributes; i++){
                if (i < 10){
					...
					FastVector classLabelsFeature = new FastVector();
					classLabelsFeature.addElement("neg");
					classLabelsFeature.addElement("pos");
					attributes.addElement(new Attribute("att"+(i+1),classLabelsFeature));
                }
			}
